    ...
    <div class="container">
        <div class="breadcrumb-content">
            <ul>
                ...
                ?>
                <li class="active"><?php echo $row_bai['tenbaiviet'] ?></li>
            </ul>
        </div>
    </div>
</div>
                        ...
                        <div class="li-blog-single-item pb-30">
                            ...
                            <div class="li-blog-content">
                                <div class="li-blog-details">
                                    <h3 class="li-blog-heading pt-25"><a href="#"><?php echo $row_bai['tenbaiviet'] ?></a></h3>
                                    ...
                                    <div class="li-blog-blockquote">
                                        <blockquote>
                                            <p><?php echo $row_bai['tomtat']?></p>
                                        </blockquote>
                                    </div>
                                    <!-- Blog Blockquote Area End Here -->
                                    <p><?php echo $row_bai['noidung']?></p>
                                    ...
                                    <!-- <div class="fb-comments" data-href="http://localhost/BanHangDienTu/index.php?quanly=chitiettin&id_tin=<?php echo $row_bai['baiviet_id']?>" data-width="" data-numposts="5" style="padding-left: 180px;"></div>-->
                                </div> 
                            </div>
                        </div>
