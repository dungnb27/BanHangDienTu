						...
						<div class="product-sec1 px-sm-4 px-3 py-sm-5  py-3 mb-4">
							<div class="row">	
                                <?php if(isset($_SESSION['dangnhap_home'])){ ?>
                                    <h4><?php echo "Đơn hàng: ".$_SESSION['dangnhap_home'] ?></h4>
                                <?php } ?>
						        <div class="col-md-12">
                                    <?php
                                        ...
                                        $sql_select = mysqli_query($con,"SELECT * FROM tbl_giaodich WHERE tbl_giaodich.khachhang_id = '$id_khachhang' GROUP BY magiaodich ORDER BY giaodich_id DESC");
                                    ?>
                                    <br><table class="table table-bordered ">
                                        ...
                                        <tr>
                                            ...
                                            ?></td>
                                            <td>
                                                <a href="index.php?quanly=xemdonhang&khachhang=<?php echo $_SESSION['khachhang_id'] ?>&magiaodich=<?php echo $row_donhang['magiaodich'] ?>">Xem chi tiết</a> 
                                            </td>
                                            <td>
                                                <?php
                                                    if($row_donhang['huydon']==0){
                                                ?>
                                                <a href="index.php?quanly=xemdonhang&khachhang=<?php echo $_SESSION['khachhang_id'] ?>&magiaodich=<?php echo $row_donhang['magiaodich'] ?>&huydon=1">
