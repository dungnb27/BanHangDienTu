                                            ...
                                            <div class="product-image">
                                                <a href="?quanly=chitietsp&id=<?php echo $row_sanpham['sanpham_id'] ?>">
                                                    <img src="uploads/<?php echo $row_sanpham['sanpham_image']?>"
                                                        alt="Li's Product Image" style="height: 255px;">
                                                </a>
                                                ...
                                                <div class="product_desc_info">
                                                    <div class="product-review">
                                                        <!-- <h5 class="manufacturer">
                                                            <a
                                                                href="?quanly=danhmuc&id=<?php echo $row_sanpham['category_id'] ?>">
                                                                <?php echo $row_sanpham['category_name'] ?>
                                                            </a>
                                                        </h5>
                                                ...
                                                <div class="single-add-to-cart">
                                                    <form action="?quanly=giohang" method="post" class="cart-quantity">
                                                        <fieldset>
                                                            ...
                                                            <input class="add-to-cart" type="submit" name="themgiohang"
