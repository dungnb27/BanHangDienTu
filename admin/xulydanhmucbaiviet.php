     ...
     <div class="container">
        ...
        <div class="col-md-4">
            ...
            <form action="" method="POST">
                ...
                <input type="hidden" class="form-control" name="id_danhmuc" value="<?php echo $row_capnhat['danhmuctin_id'] ?>" required="">
        ...
        ?>
            ...
            <div class="col-md-8">
                ...
                <table class="table table-bordered ">
                    ...
                    <?php
                        $i=0;
                        while($row_danhmuctin = mysqli_fetch_array($sql_select)){
                            $i++;
                    ...
                    <tr>
                        ...
                        <td><a href="?xoa=<?php echo $row_danhmuctin['danhmuctin_id'] ?>">Xóa</a> || 
                            <a href="?quanly=capnhat&id=<?php echo $row_danhmuctin['danhmuctin_id'] ?>">Cập nhật</a></td>
                    </tr>
                    <?php
                        }
                    ?>
